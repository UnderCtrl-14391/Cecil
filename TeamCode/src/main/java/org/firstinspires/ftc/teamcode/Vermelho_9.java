...
public class Vermelho_9 extends AutoFunction{
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            //Giro load 1
            stopResetMotors();
            autonomous(500, -500, 500, -500, 0.8, 0.8, 0, CatapultaModes.HOLD , 0.87);
            ...
            //load 1
            stopResetMotors();
            autonomous(2000, 2000, 2000, 2000, 0.5, 0.5, 0.9, CatapultaModes.HOLD, 2.1);

            //loading
            stopResetMotors();
            autonomous(789 , 8789 , 87678 , 789 , 0 , 0 , 0.9 , CatapultaModes.HOLD , 0.5);

            // ré - score 6 balls
            stopResetMotors();
            autonomous(-600, -600, -600, -600, 0.8, 0.8, 0.9, CatapultaModes.HOLD, 0.6);
            ...
            //load 2
            stopResetMotors();
            autonomous(2200, 2200, 2200, 2200, 0.85, 0.85, 0.9, CatapultaModes.HOLD, 1.5);
            ...
            //ré score 9 balls
            stopResetMotors();
            autonomous(-700, -700, -700, -700, 0.8, 0.8, 0.9, CatapultaModes.HOLD, 0.75);
